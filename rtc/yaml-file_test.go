...
func TestParseYAML(t *testing.T) {
	...
	want := []Item{
		...
		{Define: S("standard-transform"), Transform: []*YAMLTransform{{Type: S("translate"), X: F(1), Y: F(-1), Z: F(1)}, {Type: S("scale"), X: F(0.5), Y: F(0.5), Z: F(0.5)}}},
		{Define: S("large-object"), Transform: []*YAMLTransform{{NamedItem: S("standard-transform")}, {Type: S("scale"), X: F(3.5), Y: F(3.5), Z: F(3.5)}}},
		{Define: S("medium-object"), Transform: []*YAMLTransform{{NamedItem: S("standard-transform")}, {Type: S("scale"), X: F(3), Y: F(3), Z: F(3)}}},
		{Define: S("small-object"), Transform: []*YAMLTransform{{NamedItem: S("standard-transform")}, {Type: S("scale"), X: F(2), Y: F(2), Z: F(2)}}},
		{Add: S("plane")},
		{Add: S("sphere")},
		{Add: S("cube")},
		{Add: S("cube")},
