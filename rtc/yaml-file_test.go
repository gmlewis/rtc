...
func TestParseYAML(t *testing.T) {
	...
	want := []Item{
		...
		{Define: S("standard-transform"), ValueArray: []*ValueArrayItem{{Transform: &YAMLTransform{Type: "translate", X: 1, Y: -1, Z: 1}}, {Transform: &YAMLTransform{Type: "scale", X: 0.5, Y: 0.5, Z: 0.5}}}},
		{Define: S("large-object"), ValueArray: []*ValueArrayItem{{NamedItem: S("standard-transform")}, {Transform: &YAMLTransform{Type: "scale", X: 3.5, Y: 3.5, Z: 3.5}}}},
		{Define: S("medium-object"), ValueArray: []*ValueArrayItem{{NamedItem: S("standard-transform")}, {Transform: &YAMLTransform{Type: "scale", X: 3, Y: 3, Z: 3}}}},
		{Define: S("small-object"), ValueArray: []*ValueArrayItem{{NamedItem: S("standard-transform")}, {Transform: &YAMLTransform{Type: "scale", X: 2, Y: 2, Z: 2}}}},
		{Add: S("plane")},
		{Add: S("sphere")},
		{Add: S("cube")},
		{Add: S("cube")},
